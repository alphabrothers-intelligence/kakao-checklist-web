  ...
  return <div className="container result" ref={ref}>
    <div className="result-hero">
      <div className="result-hero-copy">
        <p className="result-badge">우리 사업 맞춤 광고 가이드</p>
    ...
    <div className="actions" data-export-ignore>
      <button onClick={onRestart}>다시 테스트하기</button><button className="save" onClick={onSave}>결과 다운로드하기</button><button className="guide-primary" onClick={onGuide}>광고 가이드 확인하기</button>
    </div>
