...
| 입력 | 선택 수 | 연결되는 결과 |
|---|---:|---|
| Q1 업종 | 6 | ① 업종별 TOP3·각 광고의 추천 이유 |
| Q2 전환 경로 | 5 | ② 경로별 문제 해결 안내 + ③ 유형별 광고 |
| Q3 문제 상황 | 5 | ② 발견된 문제·상황 해결·구조 개선·주의 사항 |
| Q4 목표 | 4 | ③ 전환 경로 × 목표에 따른 광고 2개 |

- **전체 조합: 6 × 5 × 5 × 4 = 600개.** 2026년 9월 15일 제공 기준.
- 운영 안내는 경로 × 문제별 발견된 문제와 3가지 안내를 표시.
